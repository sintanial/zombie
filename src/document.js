...
class Screen {
  constructor() {
    ...
    this._availWidth = this.width;
    this._availHeight = this.height;
  }
...
function setupWindow(window, args) {
  ...
  Object.assign(window.navigator, browser.navigator);
  ...
  window.navigator = Object.assign(window.navigator, browser.navigator);
